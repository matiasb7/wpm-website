...
export default function Score ({ wpm, accuracy, modifierClass }: { wpm: string, accuracy: number, modifierClass: string | undefined }) {
  const animatedWPM = useCountUp(Number(wpm), 1500) // Duration is 2000ms or 2 seconds
